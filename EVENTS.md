...
This triggers on 3 IOCs `IPv4 addresses`, `domain names`, and `md5s` described in the developer documentation https://developer.carbonblack.com/reference/enterprise-response/5.1/threat-intelligence-feeds/ |
