...
cd ./src/github.com/carbonblack/cb-event-forwarder && go get -u github.com/golang/protbuf/proto && go get -u github.com/golang/protobuf/protoc-gen-go && make rpmbuild
